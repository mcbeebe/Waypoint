...
| 009 | The Adult Transition — an age-keyed arc (the first non-diagnosis journey), clocks for the real dates, a triage rung, transition letters | Open — **owner go, both scope questions answered Sep 15**: present legal options but never a legal opinion; ages 14 → school exit (an event, not an age). B1 next. | — | [intent](009-adult-transition/intent.md) · [plan](009-adult-transition/plan.md) |
