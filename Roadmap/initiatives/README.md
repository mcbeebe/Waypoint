...
| 008 | Prove the authorization boundary — cross-tenant RLS integration tests against a real Postgres, plus a production drift report | Draft — scoped, awaiting owner go (4 open questions in intent) | — | [intent](008-prove-the-authorization-boundary/intent.md) |
