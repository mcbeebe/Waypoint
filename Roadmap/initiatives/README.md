...
| 004 | The Learn content engine (phase 8) — derive ~40 cited articles, a reader, SEO | Open — **owner approved the ~40 scope Sep 15** (explicitly NOT phase 8's "dozens, then hundreds"). Manifest derivation under way. | — | [intent](004-learn-content-engine/intent.md) · [plan](004-learn-content-engine/plan.md) |
