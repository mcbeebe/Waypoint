...
| 007 | Family Sharing, made real — owner seeded as member (027, unapplied), then RLS re-scoped owner→membership, invite email delivery + tokenized accept flow | Open — decisions confirmed (free · whole-file · member-only · Resend · SDP yes); B1 (RLS to membership, 053) MERGED #182 + applied; B3 (accept flow, 054 + Join screen) + 055 (family_members policy-recursion fix, the root cause behind "0 members") MERGED #183 + applied; B2 (Resend invitation email — family-invite Edge Function, 056) built for owner go | #182, #183 | [intent](007-family-sharing-invites/intent.md) · [analysis](007-family-sharing-invites/analysis.md) · [plan](007-family-sharing-invites/plan.md) |
