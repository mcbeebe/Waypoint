...
| 008 | Chabot local tools — hyper-local pilot: Family Navigator 1-pager, parent Google Group, one-page site, school-year paper tools | Open — Navigator drafted, awaiting owner fill-in + fact re-verify; family-facing, so nothing auto-ships | — | [intent](008-chabot-local-tools/intent.md) · [recommendations](008-chabot-local-tools/recommendations.md) · [navigator draft](008-chabot-local-tools/navigator-draft.md) |
