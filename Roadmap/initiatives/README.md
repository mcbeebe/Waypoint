...
| 008 | Prove the authorization boundary — cross-tenant RLS integration tests against a real Postgres, plus a production drift report | **Ready to build** — owner answered all four scoping questions (Sep 4 2026): bare Postgres harness, full scope, no external deadline, drift report owner-run first. PRs A–D planned. | — | [intent](008-prove-the-authorization-boundary/intent.md) · [plan](008-prove-the-authorization-boundary/plan.md) |
