...
| 009 | The Adult Transition — an age-keyed arc (the first non-diagnosis journey), clocks for the real dates, a triage rung, transition letters | Open — plan for owner go; two scope questions open (credentialed read for legal-capacity content; age cap) | — | [intent](009-adult-transition/intent.md) · [plan](009-adult-transition/plan.md) |
