...
| 007 | Family Sharing, made real — owner seeded as member (027, unapplied), then RLS re-scoped owner→membership, invite email delivery + tokenized accept flow | Open — plan for owner go (no code yet) | — | [intent](007-family-sharing-invites/intent.md) · [analysis](007-family-sharing-invites/analysis.md) · [plan](007-family-sharing-invites/plan.md) |
