...
| 007 | Family Sharing, made real — owner seeded as member (027, unapplied), then RLS re-scoped owner→membership, invite email delivery + tokenized accept flow | Open — B1 (RLS to membership, 053, #182) and B3 (accept flow, 054 + Join screen) + 055 (family_members policy-recursion fix, the root cause behind "0 members") built for owner go; B2 (Resend email) next | — | [intent](007-family-sharing-invites/intent.md) · [analysis](007-family-sharing-invites/analysis.md) · [plan](007-family-sharing-invites/plan.md) |
