...
create index idx_insurance_auth_family on public.insurance_authorizations(family_id);
create index idx_insurance_auth_end on public.insurance_authorizations(end_date);
