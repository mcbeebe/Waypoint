...
export const REQUEST_LEVERS: Record<RequestType, { template: string; label: string }> = {
  ...
  service_request: { template: 'noa_request', label: 'Demand a written Notice of Action' },
  authorization: { template: 'noa_request', label: 'Demand a written Notice of Action' },
