...
export const LETTER_TEMPLATES: LetterTemplate[] = [
  ...
  { key: 'ipp_need_request', title: 'Add a Need to the IPP', emoji: '📌', description: 'A friendly ask to write a specific need into the IPP, so the support that meets it can be funded (W&I §4646.5 / §4648(a)).', audience: 'Regional Center', defaultRequest: "I'd like to add a note to my child's IPP about a specific need our family is facing, and look at a support that would help meet it. Could we get this written into the plan as an identified need? I understand that what the IPP lists is what the Regional Center works to secure, so I'd appreciate your help making sure it's captured." },
  ...
  { key: 'delivery_plan_request', title: 'Delivery Plan Ask', emoji: '🤝', description: 'Authorized hours not arriving? A friendly ask for a delivery plan or an alternative vendor — waitlists don\'t pause the RC\'s obligation.', audience: 'Regional Center', defaultRequest: "My child has services authorized in the IPP that aren't being fully delivered yet. I'd love your help closing the gap — could you share a plan for getting these hours delivered, or help us find an alternative vendor or another way to provide them? I'm keeping a log of authorized vs. delivered hours and happy to share it." },
  { key: 'progress_data_request', title: 'Progress Data Request', emoji: '📊', description: 'A friendly ask for progress on every IEP goal plus service delivery logs — the 5-business-day records clock applies.', audience: 'School district', defaultRequest: "I'd like to stay on top of how my child is doing, and I'd appreciate your help. Could you please send: (1) current progress data on each annual IEP goal, measured as the IEP describes, and (2) the service delivery logs for the last grading period showing minutes delivered for each service. I understand records are provided within 5 business days of a written request. Thank you for everything you do for my child." },
