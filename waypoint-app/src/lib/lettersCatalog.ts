...
export const LETTER_TEMPLATES: LetterTemplate[] = [
  ...
  { key: 'sdp_info_request', title: 'SDP Info Request', emoji: '🧭', description: 'Ask about Self-Determination: orientation referral, your child\'s authorizations, and budget basis.', audience: 'Regional Center', defaultRequest: "I want to learn about the Self-Determination Program for my child. Please: (1) refer us to the next SDP orientation, (2) send copies of all of my child's service authorizations from the last 12 months, and (3) explain how the individual budget would be calculated." },
